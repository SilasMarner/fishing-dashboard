...
SPECIES = {
    "freeport_tx": [
        ...
        "Sheepshead", "Cobia", "Spanish Mackerel", "Atlantic Croaker",
        "Southern Kingfish (Whiting)", "Sand Trout", "Gafftopsail Catfish",
        "Hardhead Catfish", "Tarpon", "Pompano", "Jack Crevalle",
        "Tripletail", "Bull Shark", "Blacktip Shark", "Other",
    ],
    "padre_island_tx": [
        "Spotted Seatrout", "Red Drum (Redfish)", "Southern Flounder", "Black Drum",
        "Sheepshead", "Cobia", "Spanish Mackerel", "Atlantic Croaker",
        "Southern Kingfish (Whiting)", "Sand Trout", "Snook", "Pompano",
        "Gafftopsail Catfish", "Hardhead Catfish", "Tarpon", "Jack Crevalle",
        "Bull Shark", "Blacktip Shark", "Other",
    ],
    "pensacola_fl": [
        "Spotted Seatrout", "Red Drum (Redfish)", "Southern Flounder", "Black Drum",
        "Sheepshead", "Cobia", "Spanish Mackerel", "King Mackerel",
        "Greater Amberjack", "Red Snapper", "Vermilion Snapper", "Lane Snapper",
        "Gag Grouper", "Red Grouper", "Scamp Grouper", "Snook", "Pompano",
        "Bluefish", "Gray Triggerfish", "Little Tunny", "Tarpon",
        "Jack Crevalle", "Tripletail", "Bull Shark", "Blacktip Shark", "Other",
    ],
    "sargent_tx": [
        "Spotted Seatrout", "Red Drum (Redfish)", "Southern Flounder", "Black Drum",
        "Sheepshead", "Cobia", "Spanish Mackerel", "Atlantic Croaker",
